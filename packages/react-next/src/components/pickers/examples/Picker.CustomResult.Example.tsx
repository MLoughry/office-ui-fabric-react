...
import {
  ...
  DocumentCardPreview,
  DocumentCardTitle,
} from '@fluentui/react-next/lib/DocumentCard';
import { ImageFit } from '@fluentui/react-next/lib/Image';
...
} from '@fluentui/react-next/lib/Pickers';
...
const SuggestedBigItem: (
  documentProps: IFullDocumentCardProps,
  itemProps: ISuggestionItemProps<unknown>,
) => JSX.Element = (documentProps: IFullDocumentCardProps, itemProps: ISuggestionItemProps<unknown>) => {
...
export class PickerCustomResultExample extends React.Component<{}, IPeoplePickerExampleState> {
  ...
  private _getTextFromItem(props: IFullDocumentCardProps): string {
